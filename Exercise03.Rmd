...
Draw 10 random samples of size $N = 5$ from the standard normal distribution ($\mu$ = 0, $\sigma$ = 1). Calculate the mean of each sample. Calculate the mean of all 10 means.
