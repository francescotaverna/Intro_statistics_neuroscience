...
<div class='fold s o'>
```{r results='hold',fig.align='center',out.width = '80%'}
par(mfrow=c(1,2))
...
<div class='fold s o'>
```{r warning=FALSE, error=FALSE,message=FALSE,fig.align='center',out.width = '80%'}
...
<div class='fold s o'>
```{r results='hold',warning=FALSE,error=FALSE,message=FALSE,fig.align='center'}
